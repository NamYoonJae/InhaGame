...
void cMainGame::Setup()
{
	...
	m_pBezier = new bezier;
	m_pBezier->Setup();

	m_pCubeManGreen = new cCubeMan;
	m_pCubeManGreen->bezierSetup(m_pBezier->GetVertexGreen());
	
	
	m_pObjLoad = new cObjLoad;
	m_pObjLoad->Setup();
